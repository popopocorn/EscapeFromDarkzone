...
namespace Matrix4x4
{
	...
	inline XMFLOAT4X4 Scale(const XMFLOAT4X4& xmf4x4Matrix, const float fScale)
	{
		XMFLOAT4X4 xmf4x4Result;
...
*/
	...
	inline XMFLOAT4X4 AffineTransformation(const XMFLOAT3& xmf3Scaling, const XMFLOAT3& xmf3RotateOrigin, const XMFLOAT3& xmf3Rotation, const XMFLOAT3& xmf3Translation)
	{
		XMFLOAT4X4 xmf4x4Result;
