...
D3D12_DEPTH_STENCIL_DESC CEffectShader::CreateDepthStencilState()
{
    ...
    d3dDepthStencilDesc.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ZERO; // Depth Write Off
...
{
    m_nRootParameterStartIndex = nRootParameterStartIndex;
