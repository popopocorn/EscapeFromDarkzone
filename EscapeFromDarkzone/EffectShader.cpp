...
D3D12_INPUT_LAYOUT_DESC CEffectShader::CreateInputLayout()
{
    ...
    pDescs[4] = { "INST_SIZE",     0, DXGI_FORMAT_R32G32_FLOAT,       1, 16, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 };
    pDescs[5] = { "INST_RIGHT",    0, DXGI_FORMAT_R32G32B32_FLOAT,    1, 32, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 };
    pDescs[6] = { "INST_UP",       0, DXGI_FORMAT_R32G32B32_FLOAT,    1, 48, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 };
    pDescs[7] = { "INST_COLOR",    0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 64, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 };
